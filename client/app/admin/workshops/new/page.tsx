...
const NewWorkshopPage = () => {
    ...
    const categories = [
        ...
        { value: 'offline', label: 'Offline Program' },
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await workshopsAPI.create(formData);
                    ...
                    <div className="flex justify-between items-center py-6">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600">Create a new workshop or seminar</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="space-y-3">
                                <div className="flex space-x-2">
                                    <input
                                        ...
                                        placeholder="Add a feature or learning point"
