...
const NewAwardPage = () => {
    ...
    const categories = [
        { value: 'international', label: 'International Award' },
        { value: 'national', label: 'National Award' },
        { value: 'world-record', label: 'World Record' },
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setLoading(true);
        try {
            console.log('Creating award with data:', formData);
            const response = await awardsAPI.create(formData);
            console.log('Award creation response:', response);
                    ...
                    <div className="flex justify-between items-center py-6">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600">Create a new award or achievement</p>
                            </div>
                        </div>
                    </div>
                </div>
